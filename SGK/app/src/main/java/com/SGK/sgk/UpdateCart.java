...
public class UpdateCart extends AsyncTask<String, Void, String> {
    ...
    protected void onPreExecute() {
        u1 = ctx.getResources().getString(R.string.connection)+"updatecart.php";
        super.onPreExecute();
    }
    ...
    protected String doInBackground(String... strings) {
        ...
        try{
            ...
            data+="&"+URLEncoder.encode("totprice","UTF-8")+"="+URLEncoder.encode(total,"UTF-8");
