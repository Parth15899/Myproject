...
public class padapter extends RecyclerView.Adapter<padapter.ViewHolder> {
    ...
    public padapter(Context context,ArrayList<productClass> myList)
    {
        this.ctx = context;
        this.myList = myList;
    }
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View v  = inflater.inflate(R.layout.showproduct,parent,false);
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(@NonNull View itemView) {
            ...
            layout = itemView;
            tv1 =(TextView)itemView.findViewById(R.id.textProduct);
            tv2 =(TextView)itemView.findViewById(R.id.textPrice);
            iv1 =(ImageView)itemView.findViewById(R.id.imageProd);
